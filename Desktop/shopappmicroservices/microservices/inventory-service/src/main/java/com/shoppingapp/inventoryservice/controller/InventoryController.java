...
public class InventoryController {
    ...
    // http://localhost:8083/api/inventory/iphone-13,iphone13-white

    // http://localhost:8083/api/inventory?skuCode=iphone-13&skuCode=iphone13-white
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    // colectam toate sku pt produsele din comanda
